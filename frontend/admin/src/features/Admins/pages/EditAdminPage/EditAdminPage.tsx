...
function EditAdminPage() {
  ...
  useEffect(() => {
    GetAllRoles({ limit: 300, sort: "name_asc" })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        ...
        formData.RoleID !== (admin.Role as unknown as IRole)?._id ||
        formData.IsActivated !== admin.IsActivated
      ) {
        ...
        <div className="flex justify-between items-end pb-2">
          <div>
            <div className="flex items-center gap-2 text-sm text-on-surface-variant mb-3">
              <Link
                to="/admins"
                className="flex items-center gap-1 hover:text-primary transition-colors hover-translate-y"
              >
            ...
            <h1 className="text-[38px] font-bold text-gray-900 mb-3 tracking-tight">
              {getFullName()}
            </h1>
            <p className="text-[15px] text-gray-600 max-w-xl leading-relaxed">
              Update administrative access, roles, and account settings.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-8 flex flex-col gap-6">
            <div className="bg-white p-8 rounded-[20px] shadow-sm border border-gray-100">
              <h3 className="text-[17px] font-bold text-gray-900 mb-8">
                Admin Details
              </h3>
              <div className="mb-6">
                ...
                <div className="mt-6">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full bg-[#F9FAFB] border border-gray-100 rounded-[12px] px-5 py-3.5 text-[15px] text-gray-600"
                    placeholder={admin?.Email || "N/A"}
                  />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="mt-6">
                  ...
                  <div className="mt-6">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full bg-[#F9FAFB] border border-gray-100 rounded-[12px] px-5 py-3.5 text-[15px] text-gray-600"
                      placeholder={admin?.UserName || "N/A"}
                    />
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="mb-6 relative">
                ...
                >
                  <span
                    className={
                      formData.RoleID ? "text-gray-900" : "text-gray-400"
                    }
                  >
          ...
          <div className="md:col-span-4 flex flex-col gap-6">
            <div className="bg-white p-6 rounded-[20px] shadow-sm border border-gray-100">
              <div className="flex justify-between items-center mb-5 mt-1">
                ...
                <span
                  className={`px-2 py-0.5 text-white text-[10px] font-bold uppercase tracking-wider rounded ${formData.IsActivated ? "bg-[#064E3B]" : "bg-red-800"}`}
                >
            ...
            <div className="bg-white p-7 rounded-[20px] shadow-sm border border-gray-100">
              <h3 className="text-[16px] font-bold text-gray-900 mb-6 mt-1">
                Account Info
              </h3>
              <div className="space-y-4">
                <div>
                  ...
                  <div className="w-full bg-[#F9FAFB] border border-gray-100 rounded-[12px] px-4 py-3 text-[13px] font-mono text-gray-600 select-all break-all">
                    {admin._id || "N/A"}
                  </div>
                </div>
                <div>
